            ...
            <div class="info_box ">
                ...
                <div class="col-md-2">
                    ...
                    <div class="detail_box">
                        <a href="contact.php" class="button-con">
                            Contact and Support
                        </a>
                    </div>
                </div>
...
<footer class="footer_section">
    <div class="container">
        <div class="footer_box">
            <p>
                Copyright &copy; 2023 MAPCON2023 - IEEE Microwaves, Antennas and Propagation Conference | Powered by
                MAPCON2023 - IEEE Microwaves, Antennas and Propagation Conference
            </p>
        </div>
    </div>
</footer>
