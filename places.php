...
<head>
    ...
    <title>Places to Visit | MAPCON 2023</title>
                ...
                <div class="heading_container spon_padding">
                    ...
                    <div class=" row">
                        <div class="col-lg-6 col-xl-6 col-sm-6 col-md-6 mt-5">
                            <a href="https://goo.gl/maps/yTisAJiiFx59TAkb9">
                                <h4>Vikram Sarabhai Space Exhibition (VSSE)</h4>
                            </a>
                            <p align="justify">
                    ...
                    <div class=" row">
                        <div class="col-lg-6 col-xl-6 col-sm-6 col-md-6 mt-5">
                            <a href="https://goo.gl/maps/zZ2rXWRYRKnfPusHA">
                                <h4>Gandhi or Sabarmati Ashram</h4>
                            </a>
                            <p align="justify">
                    ...
                    <div class=" row">
                        <div class="col-lg-6 col-xl-6 col-sm-6 col-md-6 mt-5">
                            <a href="https://goo.gl/maps/ankmXgVBRVfzeeSCA">
                            ...
                            <p align="justify">
                                ...
                                <br>The major objectives of project are environment improvement, social infrastructure and sustainable development.
                                <br>A resurrection of the cityscape and the river Sabarmati in 2005 led to the making of the Sabarmati Riverfront. Boating stations and pop-up exhibition spaces are built along the river. Eleven bridges built over the Sabarmati River connect the old and new parts of the city. Of these, the Ellis Bridge is the oldest.
                                <br>Flower garden has been envisioned as a permanent flower garden spread in Approx 45000 Sqmt where more than 330 native and exotic flower species. Throughout the year, the garden serves as a city level unique park where visitors can enjoy beautiful flowers of both seasonal and non seasonal varieties. It strengthens the green space network on the western park of the city.
                            </p>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 mt-5">
                            <div class="venue-info-content">
                    ...
                    <div class=" row">
                        <div class="col-lg-6 col-xl-6 col-sm-6 col-md-6 mt-5">
                            <a href="https://goo.gl/maps/Jgu6m85iXv1beTxt8">
                                <h4>Science City</h4>
                            </a>
                            <p align="justify">
                    ...
                    <div class=" row">
                        <div class="col-lg-6 col-xl-6 col-sm-6 col-md-6 mt-5">
                            <a href="https://goo.gl/maps/8vNny75uq66CicwC7">
                                <h4>Statue of Unity (SoU)</h4>
                            </a>
                            <p align="justify">
                                ...
                                <br>It depicts Indian statesman and independence activist Vallabhbhai Patel, who was the first deputy prime minister and home minister of independent India and an adherent of Mahatma Gandhi. Patel is highly respected for his leadership in uniting 562 princely states of India to form the single Union of India.
                                <br>It was inaugurated by the Prime Minister of India, Sri Narendra Modi, on 31 October 2018, the 143rd anniversary of Patel's birth.
                            </p>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 mt-5">
                            <div class="venue-info-content">
